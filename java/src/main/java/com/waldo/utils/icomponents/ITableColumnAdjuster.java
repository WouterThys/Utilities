 ...
 */
public class ITableColumnAdjuster implements PropertyChangeListener, TableModelListener
{
     ...
     */
    public ITableColumnAdjuster(JTable table)
    {
        this(table, 6);
    }
     ...
     */
    public ITableColumnAdjuster(JTable table, int spacing)
    {
        this.table = table;
