...
public class ITextField2 extends JTextField implements FocusListener {
    ...
    public ITextField2(String hint, IEditedListener editedListener, String fieldName, boolean enabled, int columns) {
        super(columns);
    ...
    public ITextField2(String hint, IEditedListener editedListener, String fieldName, boolean enabled) {
        this(hint, editedListener, fieldName, enabled, 15);
    }

    public ITextField2(IEditedListener listener, String fieldName, boolean enabled) {
        this("", listener, fieldName, enabled, 15);
    }

    public ITextField2(IEditedListener listener, String fieldName) {
        this("", listener, fieldName, true, 15);
    }

    public ITextField2(String hint, int columns) {
        this(hint, null, null, true, columns);
    }

    public ITextField2(boolean enabled) {
        this("", null, null, enabled, 15);
    }

    public ITextField2(String hint) {
